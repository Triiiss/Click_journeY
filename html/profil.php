<?php
    ...
    $infos = array("login","mdp","email","nom","prenom","adresse","tel","dob","genre");
?>
                                ...
                                foreach ($infos as $info){
                                    if (isset($POST["new_".$info])){
                                        if($info == "login"){
                                            ...
                                            $users[$k][$info] = $_POST["new_".$info."_value"];
                                            $user[$info] = $_POST["new_".$info."_value"];
                                        }
                                        else{
                                            $users[$k]['profil'][$info] = $_POST["new_".$info."_value"];
                                            $user['profil'][$info] = $_POST["new_".$info."_value"];
                                        }
                                    }
                                }
